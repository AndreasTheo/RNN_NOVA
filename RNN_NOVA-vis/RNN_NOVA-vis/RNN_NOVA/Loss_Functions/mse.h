...
void MSE_DerivTo_Tanh_YGRAD(double* gradV, double* y, double* aFDeriv, const int aSize, double* t)
{
	for (intptr_t oN = 0; oN < (aSize - 1); oN++)
	{
...
void MSE_DerivTo_Sigmoid_YGRAD(double* gradV, double* y, double* aFDeriv, const int aSize, double* t)
{
	for (intptr_t oN = 0; oN < (aSize - 1); oN++)
	{
