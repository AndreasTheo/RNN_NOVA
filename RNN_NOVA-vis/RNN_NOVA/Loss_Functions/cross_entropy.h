...
void CrossEntropy_Binary_DerivTo_Sigmoid_YGRAD(double* gradV, double* y, const int aSize, double* t) {
...
void CrossEntropy_Binary_DerivTo_Tanh_YGRAD(double* gradV, double* y, const int aSize, double* t) {
